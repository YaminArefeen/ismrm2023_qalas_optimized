function [Mz_mtx, Mxy_mtx, Mz_mtx_all, Mxy_mtx_all] = sim_qalas_5alpha(TR, alpha_deg, esp, turbo_factor,...
    t1_vals, t2_vals, num_reps, echo2use, gap_between_readouts, time2relax_at_the_end, b1, inv_eff, pd_map )
...
Mz_mtx_all  = zeross([5*turbo_factor,num_voxels,num_reps]);
Mxy_mtx_all = zeross([5*turbo_factor,num_voxels,num_reps]);
...
%     M5 = -M4;
    ...
    Mxy_mtx_all(:,:,reps) = cat(1, Mxy_acq1, Mxy_acq2, Mxy_acq3, Mxy_acq4, Mxy_acq5);
end
toc
